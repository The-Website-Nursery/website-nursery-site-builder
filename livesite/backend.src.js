...
$(document).ready(function() {
    ...
    for (var i=0; i<=chart_table.length; i++) {
        ...
        if (chart_table[i] && ((chart_table[i].className == "chart") || (chart_table[i].className == "chart shipping_report"))) {
...
function change_page_type(page_type)
{
    ...
    if (document.getElementById('custom_form_form_name_row')) {
        ...
        document.getElementById('form_list_view_header_row').style.display = 'none';
        document.getElementById('form_list_view_footer_row').style.display = 'none';
    ...
    switch (page_type) {
        ...
        case 'form list view':
            ...
            document.getElementById('form_list_view_header_row').style.display = '';
            document.getElementById('form_list_view_footer_row').style.display = '';
            break;
